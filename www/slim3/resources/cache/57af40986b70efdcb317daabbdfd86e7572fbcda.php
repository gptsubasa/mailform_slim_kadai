<?php $__env->startSection('title','送付先入力'); ?>
								...
								<td class="custom">
									<ul>
										<li class="zip">
											...
											<input type="text" name="zip1" value="" placeholder="123" class="size2" maxlength="3" pattern="\d*" title="半角数字を入力してください">
											<span class="bar">-</span>
											<input type="text" name="zip2" value="" placeholder="1234" class="size1" maxlength="4" pattern="\d*" title="半角数字を入力してください">
											<b class="errorTxt"></b>
										</li>
										<li>
											<span>都道府県</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/slim3/resources/views/form/input.blade.php ENDPATH**/ ?>